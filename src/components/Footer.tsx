...
const column1 = [
  { name: "درباره تک نت", href: "/" },
  { name: "معرفی شرکت", href: "/" },
  { name: "تماس با ما", href: "/" },
  { name: "بلاگ تک‌نت", href: "/" },
  { name: "نمایندگان فروش", href: "/" },
  { name: "صدای مشتری", href: "/" },
  { name: "مناطق تحت پوشش TD-LTE", href: "/" },
];

const column2 = [
  { name: "خدمات", href: "/" },
  { name: "اینترنت با مودم جیبی", href: "/" },
  { name: "اینترنت وایرلس", href: "/" },
  { name: "اینترنت برج ها و مجتمع ها", href: "/" },
];

const column3 = [
  { name: "سرور اختصاصی", href: "/" },
  { name: "تلفن اینترنتی", href: "/" },
  { name: "خدمات VPLS", href: "/" },
];
  ...
  return (
    <footer className="bg-neutral-900 text-neutral-300 dark:text-neutral-400">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-12 pb-12 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-5">
        <div className="col-span-2 sm:col-span-3 md:col-span-3 lg:col-span-2 2xl:col-span-2">
          ...
          <p className="md:text-sm pt-4 w-auto sm:w-6/12 md:w-6/12 lg:w-8/12">
           شرکت تک‌نت به عنوان دارنده مجوز ISDP، VOIP و SERVCO از سازمان تنظیم مقررات و ارتباطات رادیویی، در تمامی شهرها و روستاها فعالیت دارد و پهنای باند مورد نیاز خود را به صورت مستقیم از شرکت ارتباطات زیرساخت تامین می کند.
          </p>
      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 p-6 text-center border-t border-neutral-800">
        ...
        >
          &copy; Copyright {new Date().getFullYear()} اینترنت پرسرعت تک‌نت. کلیه حقوق این وب سایت متعلق به سایت تک‌نت است
        </Link>
      </div>
    </footer>
  );
